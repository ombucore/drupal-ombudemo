...
<head>
  ...
  <?php print $head; ?>
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300italic,400,400italic,600,700,700italic,800|Open+Sans+Condensed:300|Lobster" rel="stylesheet" type="text/css">
  <?php print $styles; ?>
